...
func HexPayloadEncoderSpec(c gs.Context) {

	c.Specify("A HexPayloadEncoder", func() {
		encoder := new(HexPayloadEncoder)
...
:Logger: loggyloglog
:Payload: 
00000000  54 68 69 73 20 69 73 20  74 68 65 20 70 61 79 6c  |This is the payl|
00000010  6f 61 64 21                                       |oad!|
:EnvVersion: 0.8
:Severity: 7
:Fields:
